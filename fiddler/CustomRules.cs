...
namespace Fiddler
{
    public static class Handlers 
    {
        ...
        */
		...
		//	if (oSession.uriContains("epicgames.com/friends")) {
		//		string authstring = oSession.oRequest["Authorization"];
		//		string request_url =  oSession.PathAndQuery;
		//	}


		//	if (oSession.uriContains("epicgames.com/epic-service-worker.js")) {
			//	FiddlerObject.alert('test')
			//	}


//	if (oSession.uriContains("https://ue-launcher-website-prod.ol.epicgames.com/ue/community")) {
//	string data =  oSession.oRequest["Authorization"];
//	FiddlerObject.alert(data);
//	}
			//	if (oSession.uriContains("https://ue-launcher-website-prod.ol.epicgames.com/epic-service-worker.js")) {
					//	string data = oSession.RequestHeaders.GetTokenValue("Cookie");
//	string data =  oSession.oRequest["Cookie"];
				//	FiddlerObject.alert(data);
		...
		//	}
			...
			if (oSession.uriContains("epicgames.com/friends")) {
				authstring = oSession.oRequest["Authorization"];
				request_url =  oSession.PathAndQuery;
			}
//			if (oSession.uriContains("https://ue-launcher-website-prod.ol.epicgames.com/ue/community")) {
//				authstring = oSession.oRequest["Authorization"];
//				request_url =  "none"; //account is not listed just refresh token
//			}
